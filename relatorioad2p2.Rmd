...
require(grDevices)
palette(rainbow(12, s = 0.6, v = 0.75))
stars(popularidade_pais[, 2:6], key.loc = c(5, 2), main = "Popularidade", draw.segments = TRUE, full = FALSE, labels =c("Canada","France","Jamaica","United Kingdom","United States"), scale = TRUE)
```
